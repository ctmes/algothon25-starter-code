...
MA_LONG = 20
RSI_LOOKBACK = 14
MOMENTUM_THRESHOLD = 0.03 # Threshold for momentum to trigger trades (THIS IS OPTIMIZED)
VOL_THRESHOLD = 0.013 # Threshold for volatility to allow trades (THIS IS OPTIMIZED)
RSI_LONG = 60
RSI_SHORT = 40
TRAILING_STOP = 0.05
